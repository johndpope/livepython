...
var _VariableInspector = __webpack_require__(334);

var _VariableInspector2 = _interopRequireDefault(_VariableInspector);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_VariableInspector2.default, null), document.getElementById("root"));
...
var VariableInspector = function (_Component) {
  _inherits(VariableInspector, _Component);

  function VariableInspector() {
    _classCallCheck(this, VariableInspector);

    var _this = _possibleConstructorReturn(this, (VariableInspector.__proto__ || Object.getPrototypeOf(VariableInspector)).call(this));
  ...
  _createClass(VariableInspector, [{
    key: "componentWillMount",
    value: function componentWillMount() {
      var _this2 = this;

      _electron.ipcRenderer.send('command', {
        type: 'connected'
      });
      _electron.ipcRenderer.on('trace', function (event, data) {
        var msg = JSON.parse(data.msg);
        if (msg.type === 'call') {
          _this2.setState({
            variables: Object.assign(msg.frame_locals, msg.frame_globals),
            prevVariables: Object.assign(_this2.state.variables),
            recentlyChanged: arrDiff(Object.keys(msg.frame_locals).concat(Object.keys(msg.frame_globals)), Object.keys(_this2.state.variables))
          });
        }
      });
    }
    ...
    value: function getKeys() {
      ...
      for (var i = 0; i < keys.length; i++) {
        ...
        if (this.state.hideModules && (type === "module" || type === "function" || type === "classobj" || type === '_Feature' || type === 'type')) {
          continue;
        }
    ...
    key: "toggleModuleHide",
    value: function toggleModuleHide() {
    ...
    value: function render() {
      ...
      for (var i = 0; i < keys.length; i++) {
        ...
        var size = this.state.variables[name].size;
        ...
        rows.push(_react2.default.createElement(
          ...
          _react2.default.createElement(
            "td",
            { className: th },
            truncateString(value.toString(), 30000)
          )
        ));
        if (type == "Tensor") {
          this.state.tensorRows.push(_react2.default.createElement(
            "tr",
            { key: name, className: cs },
            _react2.default.createElement(
              "td",
      ...
      return _react2.default.createElement(
        "div",
        { id: "variables-view" },
        _react2.default.createElement("input", { id: "variable-search", placeholder: "Search for a variable", type: "text", onChange: this.filterChange.bind(this), ref: function ref(input) {
            _this3.searchInput = input;
          } }),
        _react2.default.createElement(
          "div",
          { style: { margin: "10px" } },
          _react2.default.createElement("input", { checked: this.state.hideModules, type: "checkbox", onChange: function onChange() {
              return _this3.setState({ hideModules: !_this3.state.hideModules });
            } }),
...
exports.default = VariableInspector;
